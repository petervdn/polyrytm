...
<template>
  <div class="controls-wrapper">
    <p class="info">
      Discs are the main objects of Polyrytm. They consist of rings (max {{ constants.MAX_RINGS }})
      and samples (max {{ constants.MAX_SAMPLES }}). Each sample can be divided into slices, which
      are the actual sounds that will be played, as controlled by the rings.
    </p>
    ...
    <div v-if="!selectedDisc"><p class="no-selection">No disc selected</p></div>
  </div>
</template>
