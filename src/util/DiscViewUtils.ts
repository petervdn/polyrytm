...
export const getSizeData: (element: HTMLElement) => ISizeData = (element: HTMLElement) => {
	...
	const waveformInnerRadius = { factor: waveformOuterRadius.factor - waveformSize.factor, pixels: 0 };
	const ringsOuterMargin = { factor: 0.05, pixels: 0 };
	const ringsOuterRadius = { factor: waveformInnerRadius.factor - ringsOuterMargin.factor, pixels: 0 };
