...
export function getRingItemColorForVolume(theme: ITheme, volume: number): string {
  const color = blendColors(
    [
      theme.discVolumeOffColor.rgb.r,
      theme.discVolumeOffColor.rgb.g,
      theme.discVolumeOffColor.rgb.b,
      1,
    ],
    [
      theme.discVolumeOnColor.rgb.r,
      theme.discVolumeOnColor.rgb.g,
      theme.discVolumeOnColor.rgb.b,
      volume,
    ],
  );
