...
export function getRingIndexForPosition(position: IPoint, sizeData: ISizeData): number {
	const distanceToCenter = distance(position.x, position.y, sizeData.halfSquareSize, sizeData.halfSquareSize);
...
export function getDistanceToCenterFactorForPoint(point: IPoint, sizeData: ISizeData): number {
	return distance(point.x, point.y, sizeData.halfSquareSize, sizeData.halfSquareSize) / sizeData.halfSquareSize;
}
 ...
 * @returns {number}
 */
function getRadiansForPosition(x: number, y: number, centerX: number, centerY: number, radiansOffset: number): number {
	const dx = x - centerX;
	const dy = y - centerY;
 ...
 * @returns {number}
 */
export function getSliceForPosition(position: IPoint, sizeData: ISizeData, slices: ISoundSlice[]): ISoundSlice {
	const radiansFactor =
